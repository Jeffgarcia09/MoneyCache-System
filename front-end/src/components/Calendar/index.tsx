...
const CalendarComponent = () => {
  ...
  useEffect(() => {
    // Retrieve the client_name from local storage when the component mounts
    const savedClientName = localStorage.getItem("client_name");
    if (savedClientName) {
      setClintName(savedClientName);
    }
  }, []);
  ...
  const handleTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Save the client_name to local storage whenever it changes
      ...
      {showModal && (
        ...
        >
          ...
          <ContentCont>
                ...
                />
                <label><a style={{color:"red"}}>*</a>Phone Number/Email</label>
                <input
                  type="text"
