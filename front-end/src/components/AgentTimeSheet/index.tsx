    ...
    <Container style={{boxShadow: "rgba(0, 0, 0, 0.15) 0px 0.5rem 1rem"}}>
      ...
      <WidgetContainer>
        <InCard style={{ backgroundColor: "rgba(109, 189, 72, 0.5)" }}>
          <Counter>{totalLoggedHoursThisWeek} hrs</Counter>
          <Line />
          <div style={{ textAlign: "center" }}>
            <span style={{ fontWeight: "bold" }}>This Week Logged Time</span>
          </div>
        </InCard>
        <InCard style={{ backgroundColor: "rgba(82, 171, 249, 0.5)" }}>
          <Counter>{totalLoggedHoursThisMonth} hrs</Counter>
          <Line />
          <div style={{ textAlign: "center" }}>
            <p style={{ fontWeight: "bold" }}>This Month Logged Time</p>
          </div>
        </InCard>
      </WidgetContainer>
        ...
        <div style={{ display: "flex", alignItems: "center", margin: "1px" }}>
          ...
          <Button><A href="/agent/addtask">Add a task</A></Button>
